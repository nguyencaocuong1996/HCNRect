...
public class LoginFrame extends javax.swing.JFrame{
    ...
    public Boolean CheckLogin(String TenDangNhap, String MatKhau) throws SQLException{
        MUser user = MUser.get(TenDangNhap, MatKhau);
        if (user != null){
            return true;
        }
        else{
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/images/icons/icon_shutdown_white_x50.png"))); // NOI18N
