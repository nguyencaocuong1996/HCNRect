 ...
 * @author WINDNCC
 */
public class JPanelChooseCustomerItem extends javax.swing.JPanel {
    ...
    public JPanelChooseCustomerItem(int customerId, String customerName, String customerPhone, int customerTypeId) {
        initComponents();
    ...
    public JPanelChooseCustomerItem() {
        initComponents();
    }
