...
--
-- Host: 127.0.0.1
-- Generation Time: May 31, 2017 at 02:23 PM
...
--
-- Dumping data for table `chi_tiet_dat_mon`
--
...
INSERT INTO `hoa_don` (`MaHD`, `MaKH`, `MaNV`, `NgayLapHD`, `TriGiaHD`, `MaBan`) VALUES
(1, 1, 1, '2017-06-11 12:00:00', 100000, 1),
(2, 1, 1, '2017-05-22 12:07:18', 500000, NULL),
(3, 2, 1, '2017-07-22 12:10:12', 500000, 23),
(4, 1, 1, '2017-05-22 12:16:49', 1390000, 24),
(5, 1, 1, '2017-05-22 12:17:29', 670000, 1),
(6, 3, 1, '2015-05-24 08:48:32', 400000, 1),
(7, 1, 1, '2015-05-25 11:19:07', 500000, 1),
(8, 1, 1, '2016-08-25 11:21:34', 530000, 3),
(9, 1, 1, '2016-05-25 11:25:25', 500000, 4),
(10, 5, 1, '2016-05-25 11:25:25', 500000, 4),
(11, 1, 1, '2015-05-25 11:27:35', 470000, 2),
(12, 1, 1, '2015-06-25 11:28:24', 370000, 2),
(13, 4, 1, '2017-05-25 11:35:53', 680000, 4),
(14, 1, 1, '2017-08-25 11:37:03', 670000, 3),
(15, 1, 1, '2017-05-26 08:42:39', 50000, 44),
(16, 4, 4, '2017-05-31 12:56:49', 500000, 53),
(17, 0, 4, '2017-05-31 12:58:53', 500000, 53),
(18, 5, 4, '2017-05-31 13:02:08', 1000000, 53);
...
(12, 'Nguyễn Cao Cường', '01689179348', 1, 'null');
...
CREATE TABLE `loai_khach_hang` (
  ...
  `GhiChuLKH` text CHARACTER SET latin1
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `loai_khach_hang` (`MaLKH`, `TenLKH`, `GhiChuLKH`) VALUES
(1, 'Vãng lai', ''),
(2, 'Vàng', NULL),
(3, 'Bạc', NULL),
(4, 'Bạch kim', NULL),
...
(31, 'Đậu bắp', 10, 'kg', 2),
(2, 'Thịt ba chỉ', 197.5, 'kg', 20),
(3, 'Thịt trâu', 220, 'kg', 20),
(4, 'Cánh gà ta', 115, 'kg', 20),
(5, 'Chân gà ta', 102, 'kg', 20),
(6, 'Tôm sú', 150, 'kg', 20),
(7, 'Cá diêu hồng', 147.5, 'kg', 20),
(8, 'Cá chép', 150, 'kg', 20),
(9, 'Cá kèo', 150, 'kg', 20),
(10, 'ếch', 200, 'kg', 20),
(11, 'Lươn', 150, 'kg', 20),
(12, 'Bia Tiger (Lon)', 99, 'Lon', 50),
...
(23, 'Đậu đỏ', 98.5, 'kg', 20),
(24, 'Cam', 99, 'kg', 20),
(25, 'Bánh mì ', 98, 'ổ', 15),
(26, 'Sườn heo', 99.5, 'kg', 20),
(27, 'Tiêu đen', 49.998, 'kg', 10),
(28, 'Sả', 100, 'kq', 10),
...
INSERT INTO `phieu_nhap_hang` (`MaPNH`, `MaNCC`, `NgayNhapHang`, `TriGiaPNH`, `SoTienDaTra`) VALUES
(1, 0, '2017-05-31', 1900000, 1900000),
(2, 0, '2017-05-31', 80000, 50000),
(3, 0, '2017-05-31', 56000, 5000),
(4, 0, '2017-05-31', 395000, 300000),
(5, 0, '2017-05-31', 755548, 75554);
...
--
ALTER TABLE `hoa_don`
  MODIFY `MaHD` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
--
-- AUTO_INCREMENT for table `khach_hang`
--
ALTER TABLE `khach_hang`
  MODIFY `MaKH` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
...
--
ALTER TABLE `phieu_dat_ban`
  MODIFY `MaPDB` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
--
-- AUTO_INCREMENT for table `phieu_nhap_hang`
--
ALTER TABLE `phieu_nhap_hang`
  MODIFY `MaPNH` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
